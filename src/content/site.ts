...
export const brand = {
  ...
  introParagraphs: [
    '個人事業の AsaiTech として、京都府木津川市を拠点に、ホームページ・Webサイトの制作やフロント実装、Flutter を使ったモバイルアプリ、技術のご相談など、できることからお手伝いしています。HTML/CSS/JavaScript に加え、React / Vue、Next.js・Gatsby・Astro、ホスティングやコードの納品にも対応できます。やり取りはオンラインが中心で、オンラインであれば全国対応も可能です。ちょっとしたことでも話しやすい関係になれたらと思っています。',

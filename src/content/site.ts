...
export const siteMeta = {
  ...
  description:
    '京都府木津川市を拠点とする個人事業 AsaiTech。ホームページ・コーポレートサイトの制作やリニューアル、レスポンシブ対応まで対応。京都・大阪・奈良・滋賀・兵庫は対面のご相談も可能。Astro・Next.js・Flutter のご相談も。',
  ...
  keywords:
    '木津川市,ホームページ作成,ホームページ制作,Webサイト制作,コーポレートサイト,LP制作,京都府,関西,個人事業,フロントエンド開発,Astro,Next.js,Flutter,AsaiTech',
...
export const brand = {
  ...
  introParagraphs: [
    '個人事業の AsaiTech として、京都府木津川市を拠点に、ホームページ・Webサイトの制作やフロント実装、Flutter を使ったモバイルアプリ、技術のご相談など、できることからお手伝いしています。HTML/CSS/JavaScript に加え、React / Vue、Next.js・Gatsby・Astro、ホスティングやコードの納品にも対応できます。やり取りはオンラインが中心ですが、ちょっとしたことでも話しやすい関係になれたらと思っています。',
...
export const services = {
  title: 'サービス',
  lead:
    'ホームページやサイト制作から部分的な実装・ご相談まで、木津川市・関西エリアをはじめ、オンラインで全国対応も可能です。内容に応じてご一緒できる範囲を伺います。',
  items: [
    {
...
export const flow = {
  title: 'ご依頼の流れ',
  lead:
    '木津川市を拠点に、関西エリアの事業者様ともできるだけ近い距離感で進めていきます。以下は目安の流れです。ご事情に応じて前後しますので、まずはお気軽にご相談ください。',
  steps: [
    {
      title: 'お問い合わせ',
      icon: 'mail',
    ...
    },
    {
      ...
      regionNote:
        'オンライン対応に加え、京都府・奈良県・大阪府・滋賀県・兵庫県であれば、対面でのお打ち合わせも可能です。',
    },
    {
      title: 'ご提案・お見積り',
      icon: 'clipboard-list',
...
export const areaCoverage = {
  ...
  paragraphs: [
    ...
    '打ち合わせはオンラインが基本ですが、京都府・奈良県・大阪府・滋賀県・兵庫県であれば対面でのヒアリングにも対応できます。「木津川市や京都南部で相談しやすい制作」「関西でサイトをつくりたいがオンライン中心で進めたい」など、ご事情に合わせて柔軟に進めます。',
    '検索で見つけていただいた方へ：キーワードだけでなく、運用のしやすさや更新の仕方まで含めて、ひとつずつ整理しながら進めていきます。気になる点があれば、お問い合わせフォームまたはメールからお気軽にご連絡ください。',
  ],
} as const;
  ...
  items: [
    {
      ...
      answer:
        'はい、オンラインでのやり取りが中心であれば、エリアを問わずご相談いただけます。京都・大阪・奈良・滋賀・兵庫におかれましては、対面での打ち合わせにも対応可能です。',
    },
    {
